 ...
 * \sa hwpl_action_t
 */
typedef hwpl_action_t tmr_action_t;
...
typedef struct HWPL_PACK {
	tmr_action_channel_t channel /*! \brief The OC or IC channel */;
	uint32_t value /*! \brief The value to read or write */;
} tmr_reqattr_t;
