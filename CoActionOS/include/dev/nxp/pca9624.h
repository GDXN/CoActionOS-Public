...
/*! \addtogroup PCA9624 PCA9624 Eight Channel LED Driver
 *
 ...
 * \ingroup NXP
 *
 * \details This driver controls NXP's PCA9624 LED driver chip.  The chip features four PWM signals to drive
 * 8 LED channels.
 *
...
#ifndef DEV_PCA9624_H_
#define DEV_PCA9624_H_
 ...
 *
 */
#define PCA9624_PTR_AUTO_INCREMENT_ALL 0x80
 ...
 *
 */
#define PCA9624_PTR_AUTO_INCREMENT_BRIGHTNESS 0xA0
 ...
 *
 */
#define PCA9624_PTR_AUTO_INCREMENT_GLOBAL 0xC0
 ...
 *
 */
#define PCA9624_PTR_AUTO_INCREMENT_BRIGHTNESS_GLOBAL 0xE0

/*! \details This defines the data structure
 * for the device's registers.  The pointer value
 * can be assigned a PCA9624_PTR_AUTO_INCREMENT_ value OR'd
 ...
 * uint8_t pwm0;
 *
 * transfer.ptr = PCA9624_PTR_AUTO_INCREMENT_ALL | offsetof(pca9624_t, pwm0);
 * ioctl(pca9624_fd, I_I2C_SETUP, &transfer);
 * read(pca9624_fd, &mode1, 1);
 *
 * \endcode
 */
typedef struct HWPL_PACK {
	...
	*/;
	...
	uint8_t pwm4 /*! \brief Duty cycle for channel 4 */;
	uint8_t pwm5 /*! \brief Duty cycle for channel 5 */;
	uint8_t pwm6 /*! \brief Duty cycle for channel 6 */;
	uint8_t pwm7 /*! \brief Duty cycle for channel 7 */;
	uint8_t grppwm /*! \brief See datasheet for details */;
	uint8_t grpfreq /*! \brief See datasheet for details */;
	uint16_t ledout /*! \brief See PCA9624_LEDOUT_ values for details */;
...
/*! \details When written to pca9624_t:ledout, turns the led off.
 *
 */
#define PCA9624_LEDOUT_OFF(x) (0)

/*! \details When written to pca9624_t:ledout, turns the led on.
 *
 */
#define PCA9624_LEDOUT_ON(x) (1 << (x*2))

/*! \details When written to pca9624_t:ledout, led is controlled by PWM.
 *
 */
#define PCA9624_LEDOUT_PWM(x) (2 << (x*2))

/*! \details When written to pca9624_t:ledout, led is controlled by GRPPWM
 * (see datasheet).
 *
 */
#define PCA9624_LEDOUT_GRPPWM(x) (3 << (x*2))
